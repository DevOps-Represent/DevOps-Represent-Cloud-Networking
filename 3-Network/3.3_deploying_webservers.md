...
5. This command just makes sure your web server restarts if it stops

    `chkconfig httpd on`

4. Let's edit our web server!
...
10. 🔁 Repeat these steps for your 2nd EC2 instance (Web Server B), but change your index.html file to be `<html><body>Hello from Web Server B!</body></html>`
...
5. You should see in the response `Hello from Web Server B!` this time
   ...
   You have now confirmed that your two web servers have been correctly set up!
