...
- Your Public Subnet has access to the Internet Gateway *(Public Route Table)*
- Your NAT Gateway has access to your Private Subnet *(Main or Default Route Table)*
